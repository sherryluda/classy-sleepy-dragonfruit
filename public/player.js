...
function initThreeModel() {
  ...
  loader.load(
    "../assets/9dbad8f4c1ce472698595bd873067b48.glb",
    (gltf) => {
      model = gltf.scene;
      scene.add(model);
    },
...
function setupControls() {
  ...
  pauseBtn.src = "../assets/pause_pressed.png";
});
pauseBtn.addEventListener("mouseup", () => {
  pauseBtn.src = "../assets/Property1=Default-1.png";
});
  
  const playDefaultSrc = "../assets/Property1=Default.png";
  const playActiveSrc = "../assets/play_pressed.png";
  const stopDefaultSrc = "../assets/Property1=Default-2.png";
  const stopActiveSrc = "../assets/stop_pressed.png";
